                    ...
                    <div class="avatar-sidebar mx-auto">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="sidebar-info text-start">
                                <h5 class="sidebar-company">AliStudio, Inc</h5>
                ...
                <div class="row">
                        ...
                        <div class="job-overview">
                            <div class="row">
                                ...
                                <div class="col-md-4 d-flex mt-sm-15">
                                    ...
                                    <div class="sidebar-text-info ml-10">
                                        <span class="text-description mb-10">Salary</span>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 col-12 mx-auto">
                        ...
                        <div class="content-single">
                            ...
                            <p>
                                <strong>Product knowledge:</strong> Deeply understand the technology and features of the
                                product
                            ...
                            <p>
                                <strong>Deliverables:</strong> Create deliverables for your product area (for example
                        ...
                        <div class="single-apply-jobs">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-7 text-lg-end social-share">
                                    <a href="#" class="btn btn-border btn-sm mr-10"><img alt="jobhub" src="assets/imgs/theme/icons/share-fb.svg" /> Share</a>
                                    <a href="#" class="btn btn-border btn-sm mr-10"><img alt="jobhub" src="assets/imgs/theme/icons/share-tw.svg" /> Share</a>
                                    <a href="#" class="btn btn-border btn-sm"><img alt="jobhub" src="assets/imgs/theme/icons/share-pinterest.svg" /> Share</a>
                                </div>
                            </div>
                        </div>
