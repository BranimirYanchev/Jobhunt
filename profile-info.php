...
<head>
    ...
    <link rel="stylesheet" href="assets/elements/profile-info-form/style.css">
</head>
...
<body>
    ...
    <?php 
        ...
        $userInfo = [];
        $hasFile = false;
        if(fetchData($_SESSION['user_id'])["file_url"] != null){
            $hasFile = true;
            $jsonData = file_get_contents(fetchData($_SESSION['user_id'])["file_url"]);
            $userInfo = json_decode($jsonData, true)['general_info'][0];
            var_dump($userInfo);
        }
    ?>
    ...
    <?php if(!$hasFile)include 'assets/elements/profile-info-form/index.php'?>
                ...
                <div class="container">
                    ...
                    <div class="heading-main-info">
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-lg-3">
                                <a href="#" class="btn btn-default">Upload CV</a>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                        <div class="content-single">
                            ...
                            <?php include 'assets/elements/editor.php' ?>
                            ...
                            <div class="block-progress-status">
                                ...
                                <div class="item-progress">
                                    <div class="title-progress"><strong class="text-md-bold">After Effect</strong> (8.5/10)</div>
                                    <div class="info-progress">
                                        <div class="progress">
